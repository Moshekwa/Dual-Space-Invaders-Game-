...
void EntityImageLoader::loadImages()
{
    vector<string> image_filenames{ "player1.png", "player2.png", "laser1.png", "laser1.png", "green_alien.png",
        ...
        "splash_screen.png", "gamewon.png", "gamelost.png", "green_alien2.png", "green_alien3.png",
        "purple_alien2.png", "purple_alien3.png", "red_alien2.png", "red_alien3.png" };
